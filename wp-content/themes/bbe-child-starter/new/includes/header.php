...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/amillionwordsaboutrace/wp-content/themes/bbe-child-starter/expanding-css/default.css" />
    <link rel="stylesheet" type="text/css" href="/amillionwordsaboutrace/wp-content/themes/bbe-child-starter/expanding-css/component.css" />
    <?php wp_head(); ?>
    ...
    <div class="navbar-header">
      <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#navbar">
       ...
       <a class="navbar-brand" href="<?php echo home_url('/'); ?>"><?php
			if ( get_theme_mod( 'themeslug_logo' ) ) { ?>  <img id="top-logo" src='<?php echo esc_url( get_theme_mod( 'themeslug_logo' ) ); ?>' alt='<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>'> <?php
			} else  { ?> <div id="top-textlogo"><?php  bloginfo('name'); ?></div> <?php } ?>
			<?php if (get_theme_mod('tagline_visibility')==""): ?><small id="top-description" class="text-muted hidden-xs hidden-sm"><?php bloginfo("description") ?></small><?php endif ?>
		</a>
    </div>
