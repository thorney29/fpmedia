...
var Grid = (function() {
	...
	Preview.prototype = {
		create : function() {
			...
			this.$href = $( '<a href="#"></a>' );
			this.$content = $( '<div class="expanded-content"></div>'  );
			this.$details = $( '<div class="og-details"></div>' ).append( this.$name, this.$title, this.$description );
			this.$teaser = $( this.$content,this.$href ).insertAfter( '<div class="og-details"></div>' ),
			this.$loading = $( '<div class="og-loading"></div>' );
			this.$fullimage = $( '<div class="og-fullimg"></div>' ).append( this.$loading );
			this.$closePreview = $( '<span class="og-close"></span>' );
			this.$previewInner = $( '<div class="og-expander-inner"></div>' ).append( this.$closePreview, this.$fullimage, this.$details, this.$teaser );
		...
		open : function() {
			// add the sparkly star
		    $('.expanded-content span:contains("1")').html(function(_, html) {
